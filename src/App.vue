...
<template>
  <n-config-provider :theme="isDark ? darkTheme : null" :theme-overrides="isDark ? darkOverrides : null">
    <Header />
    <div class="flex">
      <Sidebar id="sidebar" class="min-w-[256px] w-[256px] sticky top-20 <lg:fixed <lg:top-[64.8px] <lg:right-[-300px] <lg:z-3 lg:mr-4 h-full duration-300 bg-hex-fff dark:bg-hex-18181c" />
      <main class="flex-grow min-w-0 mt-4 pb-10 text-center text-gray-700 dark:text-gray-200">
        <router-view />
        <div
